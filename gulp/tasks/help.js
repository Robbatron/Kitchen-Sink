...
module.exports = function ( gulp, plugins, demoOrApp ) {
    ...
    return function () {
        ...
        console.log("\n  Commands available to use :\n" +
            ...
            "  \n" +
            "     --project <project name>      : Creates a new project with the project name argument passed. Argument name should be 'camelCase'.\n" +
            ...
            "     --component <component name>  : Creates a component with the given name.\n" +
            "     --template <template name>    : Creates a template with the given name.\n" +
            "\n");
